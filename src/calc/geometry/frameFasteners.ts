 ...
 *
 * ОТКРЫТЫЙ ВОПРОС: физическое назначение "Фс11/Фс14/Фс12" не
 * расшифровано — в файле это просто код позиции; судя по массе 1,4 и
 * 0,5 кг, это не саморез, а более крупный крепёжный элемент.
 *
