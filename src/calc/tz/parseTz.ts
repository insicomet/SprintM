...
export interface ParsedTz {
  ...
  windows: TzOpening[];
  /**
   * Пункт 14 — одна строка «да/нет» сразу на три вещи: организованный
   * водосток, снегозадержание и ограждение кровли. Разносится в
   * tzToInputs на все три соответствующих поля приложения (водосток,
   * снегозадержатель, прогон под ограждение) — раздельного ответа в ТЗ
   * для них нет.
   */
