...
const cases: { name: string; inputs: ProjectInputs; oracle: Oracle }[] = [
  {
    ...
    oracle: {
      ...
      bill: {
        ...
        F148: 7237575.89344468,
        F149: 9799549.54171364,
        F151: 9995540.53254791,
        F154: 64883.6822277977,
      },
    },
  },
  {
    ...
    oracle: {
      ...
      bill: {
        ...
        F148: 5053378.18377627,
        F149: 6882087.00959565,
        F151: 7019728.74978756,
        F154: 44107.667311892,
      },
    },
  },
  {
    ...
    oracle: {
      ...
      bill: {
        ...
        F148: 7036575.14513118,
        F149: 9349392.15237413,
        F151: 9536379.99542161,
        F154: 62362.9829049993,
      },
    },
  },
  {
    ...
    oracle: {
      ...
      // F100 и то, что от него зависит, пересняты после ответа расчётчика
      // на вопрос 02/03: горизонтальных связей и слагаемого болтов М16
      // вдвое меньше при пролёте ≤ 12 м — «здание укладывается в один
      // шестиметровый полупролёт с каждой стороны конька». Пролёт здесь
      // 12 м, попадает в это правило. Заодно и катет горизонтальной связи
      // при этом пролёте/2, а не пролёт/4 (подтверждено на «21987»).
      // F114 пересчитан ещё раз: надбавка на фронтоны не удваивается при
      // пролёте ровно 12 м — «Граница больше 12, начиная с 13, при
      ...
      bill: {
        ...
        F81: 57249.22176,
        F100: 588420.834998356,
        F114: 836582.274,
        F147: 978020.289763275,
        F82: 907344.301826381,
        F148: 2403023.39876163,
        F149: 3310367.70058801,
        F151: 3376575.05459977,
        F154: 20348.9427335215,
      },
    },
  },
  {
    name: "E · Увильды, 12×26, h4 — по ТЗ 22326, город не из справочника",
    inputs: {
      ...base,
      city: "Увильды",
      span: 12,
      length_m: 26,
      height_m: 4,
      // Увильды нет в нашей климатической базе — нагрузки заданы руками.
      // Подборщик знает этот посёлок и даёт то же самое: снег 1,5, ветер II.
    ...
    oracle: {
      engine: {
        sv: "4/3", framePitch_m: 6, maxPurlinStep_mm: 2150, purlinStep_mm: 2150,
        beam: "ПГС300/20х80х2,5", column: "ПГС300/20х80х2", purlin: "2ПС 245х65х2",
        boltsInFrame: 276, gussetPerFrame_kg: 233, purlinMass_kg: 2850.12,
      },
      // F100 и то, что от него зависит, пересняты трижды. Сначала —
      // вопрос 01: «Там ошибка, обрамление должно быть 31,5м» — окно
      // округляется ВВЕРХ до кратного шагу рам (windowFramingPerimeter_m).
      // Здесь окно 4,3 м у́же шага 6 м, округляется вверх до одного шага —
      // L156 = 2*(6+1)*5 = 70 п.м вместо прежних 2*(4,3+1)*5 = 53.
      // Затем — вопрос 02/03: горизонтальных связей и слагаемого болтов
      // М16 вдвое меньше при пролёте ≤ 12 м (здесь пролёт 12 м), и катет
      // горизонтальной связи пролёт/2, а не пролёт/4 (подтверждено на
      // «21987»). F114 пересчитан ещё раз: надбавка на фронтоны не
      // удваивается при пролёте ровно 12 м (см. случай D выше).
      bill: {
        F32: 915631.233676048,
        F44: 50677.8947368421,
        F70: 70741.9542857143,
        F81: 129360.535954286,
        F100: 823895.831849228,
        F114: 1000655.9856,
        F147: 1178381.43817688,
        F82: 1166411.61865289,
        F148: 3002933.25562611,
        F149: 4169344.874279,
        F151: 4252731.77176458,
        F154: 27454.9353191708,
      },
    },
  },
];
