...
const cases: { name: string; inputs: ProjectInputs; oracle: Oracle }[] = [
  ...
  },
  {
    ...
    oracle: {
      ...
      // F100 и то, что от него зависит (F148/F149/F151/F154), пересняты
      // заново после ответа расчётчика на вопрос 01: «Там ошибка,
      // обрамление должно быть 31,5м» — обрамление окна округляется
      // ВВЕРХ до кратного шагу рам (см. windowFramingPerimeter_m). Здесь
      // окно 4,3 м у́же шага 6 м, значит округляется вверх до одного
      // шага — L156 = 2*(6+1)*5 = 70 п.м вместо прежних 2*(4,3+1)*5 = 53.
      bill: {
        F32: 915631.233676048,
        F44: 50677.8947368421,
        F70: 70741.9542857143,
        F81: 129360.535954286,
        F100: 869360.370934462,
        F114: 1078117.56,
        F147: 1178381.43817688,
        F82: 1166411.61865289,
        F148: 3125859.36911134,
        F149: 4292270.98776423,
        F151: 4378116.40751952,
        F154: 28371.9674936253,
      },
    },
  },
];
