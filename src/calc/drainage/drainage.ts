...
/**
 * Цена и масса единицы — значения раздела "Водосток" (система ф150мм).
 *
 * Цены в исходной ведомости ссылаются на внешний прайс
 * "[6]Водосток(МП)", самого файла у нас нет, но закэшированные значения
 * присутствуют и полностью совпадают в обоих реальных проектах, поэтому
 * взяты как есть. Актуальность цен — на дату исходных файлов.
 */
